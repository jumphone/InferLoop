...
Section II  | x[Using Cicero to predict global loops](#section-ii-using-cicero-to-predict-global-loops) |
Section III | x[Preparing input files of InferLoop](#section-iii-preparing-input-files-of-inferloop) |
Section IV  | x[Using InferLoop to infer loop signals](#section-iv-using-inferloop-to-infer-loop-signals--python3-) |
Section V   | x[Inferring cell-type specific loop signals](#section-v-inferring-cell-type-specific-loop-signals) |
