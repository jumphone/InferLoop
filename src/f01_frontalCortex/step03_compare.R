...
pdf('/home/disk/database/data/ICS_scHIC/f01_frontalCortex/p01_cor_heatmap_all_cortex_small.pdf',width=5,height=4)
################################################################
pred.ref=readRDS('/home/disk/database/data/ICS_scHIC/f01_frontalCortex/ics_out/COM_pred.ref_mean.rds')
...
print(ht)
################################################################
pred.ref=readRDS('/home/disk/database/data/ICS_scHIC/f01_frontalCortex/ics_out/COM_pred.ref_hmean.rds')
COM=.simple_combine(real.ref,pred.ref)
D1=COM$exp_sc_mat1
D2=COM$exp_sc_mat2
ALL=cbind(D1,D2)
...
print(ht)
################################################################
pred.ref=readRDS('/home/disk/database/data/ICS_scHIC/f01_frontalCortex/ics_out/COM_pred.ref_ori.rds')
COM=.simple_combine(real.ref,pred.ref)
D1=COM$exp_sc_mat1
D2=COM$exp_sc_mat2
ALL=cbind(D1,D2)
...
#################
pred.ref=readRDS('/home/disk/database/data/scHIC/GSE130711_analysis/CiceroCellType/SCOM_Cicero_colname.rds')
COM=.simple_combine(real.ref,pred.ref)
D1=COM$exp_sc_mat1
D2=COM$exp_sc_mat2
ALL=cbind(D1,D2)
...
#pred.ref=readRDS('/home/disk/database/data/ICS_scHIC/f01_frontalCortex/ics_out/COM_pred.ref_r0pos.rds')
#COM=.simple_combine(real.ref,pred.ref)
#D1=COM$exp_sc_mat1
#D2=COM$exp_sc_mat2
#ALL=cbind(D1,D2)
