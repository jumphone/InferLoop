...
pdf('p02_sub_barplot_cortex.pdf',width=2.5,height=5)

barplot(SUB,ylim=c(-0.15,0.15),col=c(rep('grey60',3),rep('indianred1',2)),
...
################################################################
pred.ref=readRDS('/home/disk/database/data/ICS_scHIC/f01_frontalCortex/ics_out/COM_pred.ref_s.rds')
this_out=.getSub(real.ref,pred.ref)
OUT$r0pos.yes=this_out$yes
OUT$r0pos.no=this_out$no_head
################################
