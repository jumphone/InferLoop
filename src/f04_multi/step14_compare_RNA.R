...
#COL_LIST=list(DType=c('scATAC'='indianred1','scRNA'='grey60'),
...
COL_LIST=list(DType=c('scATAC'='indianred1','scRNA'='grey60'),
              CType=c('Astro'='red','Neuron.Ex'='darkgreen','Neuron.In'='darkolivegreen1','ODC'='blue3')
              )
...
pdf('./f04p01_cor_heatmap_all_multi_RNA_small.pdf',width=5,height=4)
################################################################
