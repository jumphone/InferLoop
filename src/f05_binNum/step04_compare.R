...
real.ref=readRDS('/home/disk/database/data/ICS_scHIC/f01_frontalCortex/ics_out/COM_real.ref.rds')
...
pdf('./f05p01_cor_heatmap_all_cortex_small.pdf',width=5,height=4)
################################################################
#################
