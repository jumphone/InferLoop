...
real.ref=readRDS('../f01_frontalCortex//ics_out/COM_real.ref.rds')
...
SUB=c()
################################################################
pred.ref=readRDS('./clst/COM_pred.ref_N50.rds')
this_out=.getSub(real.ref,pred.ref)
OUT[[1]]=this_out$yes
OUT[[2]]=this_out$no_head
################################################################
pred.ref=readRDS('../f01_frontalCortex/ics_out/COM_pred.ref_r0.rds')
this_out=.getSub(real.ref,pred.ref)
OUT[[3]]=this_out$yes
OUT[[4]]=this_out$no_head
################################################################
pred.ref=readRDS('./clst/COM_pred.ref_N150.rds')
this_out=.getSub(real.ref,pred.ref)
OUT[[5]]=this_out$yes
OUT[[6]]=this_out$no_head
################################################################
pred.ref=readRDS('./clst/COM_pred.ref_N200.rds')
this_out=.getSub(real.ref,pred.ref)
OUT[[7]]=this_out$yes
...
pdf('f05p02_sub_barplot_cortex.pdf',width=2.5,height=5)
